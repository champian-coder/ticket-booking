...
function searchTrain(): void {
    ...
    // Safely access the seat type based on the valid travel class
    ...
    console.log("Seat availability:", selectedSeat);
    ...
    const ticket = {
        ...
        travelClass,
        passenger: { name: passengerName, age: passengerAge },
        status: "Confirmed",
    };

    // Save the ticket to a file (you need to implement this function)
    saveTicket(ticket);
